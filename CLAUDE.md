...
EverFree started as a way out of Evernote and is now a Markdown notes app
that stores everything in a private GitHub repository the user owns, with a
desktop app, a web client, a mobile client, and an MCP server that exposes
the same notes to coding agents.
